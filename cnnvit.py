...
class cnnvit(nn.Module):
    ...
    def forward(self, x):
        ...
        features = logit.view(logit.size(0), -1)
        return logit,features


def mult_vit(img_size = 224, num_class = 1000):
    model =cnnvit(
        in_channels = 3,
        stem_channel = 16,
        cmt_channel = [46, 92, 184, 368],
...
def CMT_XS(img_size = 224, num_class = 100):
    model = cnnvit(
        in_channels = 3,
        stem_channel = 16,
...
def CMT_S(img_size = 224, num_class = 100):
    model = cnnvit(
        in_channels = 3,
        stem_channel = 32,
...
def CMT_B(img_size = 224, num_class = 100):
    model = cnnvit(
        in_channels = 3,
        stem_channel = 38,
